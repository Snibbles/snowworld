...
EXTRAS
* Could potentially make the top drop downs functional as an extra thing
* Also could work on adding cool animations 
...
<details open>
  ...
  **Jack Whitehead**
  ...
  ### Je startniveau:
  **Blauw**  
  *(Ik heb de basis van HTML, CSS en een beetje JavaScript onder de knie, maar er is altijd meer te leren.)*

  ### Je focus:
  **Responsive design** – ervoor zorgen dat mijn website soepel werkt op verschillende apparaten.
...
<details>
<summary>WCAG CHECKLIST SNOWWORLD WEBSITE ORIGINAL INZICHTEN</summary>
...
<details open>
  ...
  1. ChatGPT : Update Dots js, Organising code, 
  2. Youtube : Nav dots, Hamburger menu
  3. W3schools : general information and knowledge
  4. Codepen: Understanding grids !! Dit was belangrijk omdat flexbox is kut

https://youtu.be/iVt1ElToqHo
</details>
